...
public class Main {
    ...
    private static Scanner scanner = new Scanner(System.in); // for our user inputs
    ...
    private static void printMenu() {
        ...
        System.out.println("7. Place New Order (transaction: COMMIT/ROLLBACK)");
        System.out.println("8. Show View + Stored Procedure demo");
    ...
    // demo of the View for orders/customers join on cust_id .. Procedure lets user mark an order as shipped given the order status was = order_placed based on a user given order_id
